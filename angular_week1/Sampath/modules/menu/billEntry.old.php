        ...
        <div class="sectionEmpSearch" id="sectionEmpSearch">
            <div class="filterDiv">
                ...
                <div class="filters d-flex gap-3 my-3">
                    <div class="form-check">
                        <input onclick="window.formClass.setFilter('billId')" value="billId" class="form-check-input"
                            type="radio" name="billIdFilter" id="billIdFilterOption" />
                        <label class="form-check-label" for="billIdFilterOption">
                            Bill ID
                        </label>
                    </div>
                    <div class="form-check">
                        <input onclick="window.formClass.setFilter('empCode')" value="empCode" class="form-check-input"
                            type="radio" name="billIdFilter" id="empCodeFilterOption" />
                        <label class="form-check-label" for="empCodeFilterOption">
                            EmpCode
                        </label>
                    </div>
                    <div class="form-check">
                        <input onclick="window.formClass.setFilter('bankAcNo')" value="bankAcNo"
                            class="form-check-input" type="radio" name="billIdFilter" id="bankAcNoFilterOption" />
            ...
            <div class="filterInputsDiv">
                <div class="filterInput d-none" id="billIDSelectDiv">
                    ...
                    <div class="input">
                        <select name="" id="billId" class="form-select"
                            onchange="window.formClass.setBillId(this.value)"></select>
                    </div>
                </div>
            ...
            <div class="employeeDiv mt-3 d-none" id="employeeDiv">
                ...
                <select onchange="window.formClass.setEmployee(this)" class="form-select" name=""
                    id="employee"></select>
            </div>
        ...
        <div id="detailsDiv" class="d-none mt-3">
            <div id="billMonthYearDiv" class="">
                <div class="billMonthYear">
                    ...
                    <input type="month" name="" id="monthAndYear" class="form-control"
                        onchange="window.formClass.setMontAndYear(this.value)" />
                </div>
            </div>
            ...
            <div id="earningsDiv" class="mt-3">
                <div class="earningsInputDiv">
                    ...
                    <div class="earningAmountDiv mt-2 row m-0 col-12 gap-1">
                        <div class="col-9 p-0">
                            <input type="text" id="earningAmount" onkeypress="return /[0-9]/i.test(event.key)"
                                class="form-control" placeholder="Earnings Amount" />
                        </div>
            ...
            <div id="deductionsDiv" class="mt-3">
                <div class="deductionsInputDiv">
                    ...
                    <div class="deductionAmountDiv row mt-2 m-0 col-12 gap-1">
                        <div class="col-9 p-0">
                            <input type="text" id="deductionAmount" onkeypress="return /[0-9]/i.test(event.key)"
                                class="form-control" placeholder="Deductions Amount" />
                        </div>
